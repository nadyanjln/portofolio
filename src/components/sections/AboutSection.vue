...
<template>
  <section class="py-10 sm:py-16 relative" id="about">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-start">
        ...
        <div class="lg:col-span-7 space-y-5 sm:space-y-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-3.5 pt-1">
            <div 
              ...
              :key="item.title"
              class="p-5 rounded-2xl bg-white dark:bg-[#15161B] border border-[#EEDCDC] dark:border-white/10 space-y-2.5 hover:border-[#9E0402]/40 hover:-translate-y-1.5 transition-all duration-300 group shadow-xs hover:bg-[#FDF6F6] dark:hover:bg-[#1C1E24]"
            >
        ...
        <div class="lg:col-span-5 p-6 sm:p-7 rounded-[32px] bg-white dark:bg-[#15161B] border border-[#EEDCDC] dark:border-white/10 space-y-4 flex flex-col shadow-xs">
          <div class="flex items-center justify-between pb-2 border-b border-[#EEDCDC] dark:border-white/10">
            <div>
          ...
          <!-- 1 x 1 Vertical Scrollable List -->
          <div class="flex flex-col gap-2 max-h-[320px] overflow-y-auto pr-1.5 custom-scroll">
            <SkillBadge 
          ...
          <div class="pt-2.5 border-t border-[#EEDCDC] dark:border-white/10 flex items-center justify-between text-xs font-mono-tag text-[#5C4848] dark:text-zinc-400">
