    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 sm:space-y-12">
      ...
      <div data-reveal="fade-up" class="flex flex-col md:flex-row md:items-end justify-between gap-4 max-w-3xl">
        <div class="space-y-3">
          ...
          <h2 class="text-3xl sm:text-5xl font-extrabold text-[#1C1313] dark:text-white tracking-tight">
            Bagaimana Saya <span :class="currentProfile === 'raqwan' ? 'text-emerald-400' : 'text-[#9E0402] dark:text-[#ff3b38]'">Bekerja</span>
          </h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
        <div
          ...
          class="p-6 sm:p-7 rounded-3xl bg-white dark:bg-[#14161D] border border-[#EEDCDC] dark:border-white/10 transition-all duration-300 space-y-4 flex flex-col justify-between group shadow-xs hover:-translate-y-1.5 hover:shadow-md"
          :class="currentProfile === 'raqwan' ? 'hover:border-[#047857]/60' : 'hover:border-[#9E0402]/50 dark:hover:border-[#ff4d4d]/50'"
        >
          <!-- Top Step Index -->
          <div class="space-y-3">
